...
/***/ function(module, exports, __webpack_require__) {
	...
	var memo_component_1 = __webpack_require__(159);
	var element = document.createElement('div');
	document.getElementsByTagName('body')[0].appendChild(element);
	ReactDOM.render(React.createElement(memo_component_1.Memo, null), element);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var controlls_component_1 = __webpack_require__(160);
	var Memo = (function (_super) {
	    ...
	    Memo.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {"className": "container"}, React.createElement("div", {"className": "game"}, this.state.cards.map(function (card, index) {
	            return (React.createElement("div", {"key": index, "className": "card " + (card.state !== "normal" ? card.state : ""), "onClick": function () { _this.cardClick(card, index); }}, React.createElement("figure", {"className": "front"}), React.createElement("figure", {"className": "back"}, React.createElement("i", {"className": "fa fa-" + card.class}), React.createElement("div", null, card.setIndex))));
	        })), React.createElement("div", {"className": "timer"}, this.state.won ? "You matched all cards in " + Memo.timePad(this.state.timer) + " with " + this.state.clicks + " clicks" : Memo.timePad(this.state.timer)), React.createElement(controlls_component_1.Controlls, {"onStart": function (sets, size) { return _this.start(sets, size); }})));
	    };
	    Memo.prototype.start = function (sets, size) {
	        var _this = this;
	        clearInterval(this.state.timerId);
	        var cards = [];
	        var s = sets;
	        var icons = Memo.shuffle(Memo.icons).slice(0, sets);
	        while (s) {
	        ...
	        this.setState({
	            ...
	            setCount: +sets,
	            timer: 0,
	            timerId: setInterval(function () { _this.timerTick(); }, 1000),
	            won: false,
	            clickLock: false,
	            clicks: 0
	        });
	    };
	    Memo.prototype.timerTick = function () {
	        this.setState(function (prev) { return { timer: prev.timer + 1 }; });
	    };
	    Memo.prototype.cardClick = function (card, index) {
	        this.setState(function (prev) { return { clicks: prev.clicks + 1 }; });
	        if (card.state !== "normal" || this.state.clickLock)
	            return;
	    ...
	    Memo.prototype.match = function (index) {
	        var matchedCount = 0;
	    ...
	    Memo.prototype.isClassMatch = function (className) {
	    ...
	    Object.defineProperty(Memo.prototype, "flippedCount", {
	        get: function () {
	            var count = 0;
	            for (var i in this.state.cards) {
	    ...
	    Memo.timePad = function (time) {
	        return Math.floor(time / 60) + ':' + Memo.lPad('0', 2, "" + (time % 60));
	    };
	    Memo.lPad = function (padString, length, str) {
	        while (str.length < length)
	            str = padString + str;
	        return str;
	    };
	    Memo.replace = function (array, index, item) {
	        return [].concat(array.slice(0, index), item, array.slice(index + 1));
	    };
	    Memo.shuffle = function (array) {
	        var currentIndex = array.length, temporaryValue, randomIndex;
	        var shuffledArray = array.concat([]);
	    ...
	    Memo.icons = ['anchor', 'automobile', 'balance-scale', 'bell',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Controlls = (function (_super) {
	    __extends(Controlls, _super);
	    ...
	    Controlls.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {"className": "controls"}, React.createElement("span", {"style": { padding: "15px", backgroundColor: "#ccf", borderRadius: '10px' }}, React.createElement("label", {"htmlFor": "sets"}, "Numer of sets:"), React.createElement("input", {"type": "number", "min": "2", "step": "1", "onChange": function (e) { _this.setState({ sets: e.target['value'] }); }, "value": String(this.state.sets)}), React.createElement("label", {"htmlFor": "setSize"}, "Set size:"), React.createElement("input", {"type": "number", "min": "2", "step": "1", "onChange": function (e) { _this.setState({ size: e.target['value'] }); }, "value": String(this.state.size)}), React.createElement("span", {"className": "button", "onClick": function () { return _this.click(); }}, "Start"))));
	    };
	    Controlls.prototype.click = function () {
	        this.props.onStart && this.props.onStart(this.state.sets, this.state.size);
	    };
	    Controlls.prototype.componentDidMount = function () {
	        this.click();
	    };
	    return Controlls;
	})(React.Component);
